...
import { deleteUser, getAllUser } from "../../redux/slice/UserSlice";
  ...
  return (
    <>
      ...
      <div className="p-4 sm:ml-60">
                          ...
                          <>
                            <tr className="text-xs bg-gray-100 dark:text-gray-400 dark:bg-gray-800">
                              <td className="px-6 py-5 font-medium">
                                <img
                                  src={`https://drive.google.com/thumbnail?id=${user?.urlId}`}
                                  alt=""
                                  width="50"
                                  height="50"
        ...
        {/* </div> */}
        {open ? (
          <ModalDelete id={id} action={deleteUser} close={setOpen} />
        ) : (
          ""
        )}
      </div>
